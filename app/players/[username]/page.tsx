...
export default function PublicPlayerPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
      <ProfileHeader
        name={guestDisplayName(player.username) || UNNAMED_NAME}
        eyebrow="Player"
        ...
        {friends.length === 0 ? (
          ...
          <ul className="mt-3 flex flex-wrap gap-2">
            {friends.map((f) => (
              ...
              >
                <PlayerAvatar name={guestDisplayName(f.username) || UNNAMED_NAME} avatarUrl={f.avatarUrl} size="xs" />
                ...
                {!f.isGuest && f.username ? (
                  ...
                  <span className="text-muted-foreground">
                    {guestDisplayName(f.username) || UNNAMED_NAME}
                  </span>
                )}
