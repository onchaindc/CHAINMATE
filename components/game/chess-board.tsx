    ...
    <div className="relative w-full select-none">
      <Chessboard
        options={{
          ...
          /* Short and perceptible: ~130ms reads as instant at one-click pace
             but still shows the slide, which is how the piece can be followed
             during tournament play. */
          animationDurationInMs: 130,
          showAnimations: true,
          showNotation: true,
